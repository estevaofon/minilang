// ============================================
// MiniLang - Teste Linked List Final
// Implementação final de lista encadeada
// ============================================

print("=== TESTE LINKED LIST FINAL ===")
...
print("✓ Linked List simulada com sucesso") 