#!/usr/bin/env python3
"""
Nox Block REPL - Versão que entende a sintaxe correta da Nox
...
class NoxBlockREPL:
    def __init__(self):
        ...
        self.lexer = PygmentsLexer(NoxLexer)
    ...
    def execute_line(self, line):
        ...
        def _execute():
            ...
            with tempfile.NamedTemporaryFile(mode='w', suffix='.nx', delete=False, encoding='utf-8') as f:
...
def main():
    """Inicia o REPL com suporte a blocos Nox e isolamento de erros"""
    print("=" * 60)
    print("Nox JIT Interpreter - REPL")
    print("=" * 60)
